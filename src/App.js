...
class App extends Component {
  ...
  render() {
    ...
    if(this.state.alertshow){
      alertlay=<Hlayer type="alert" handleShow={this.handleAlertShow} config = {{contentBg: '#982a2a' ,contentColor:"#fff" ,animateType:4, position: 0, shadow: false, text:'追风少年',  confirmCb: 'close', time: 4000, icon:4,}}/>
    }
